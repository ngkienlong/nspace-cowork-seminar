...
Đây là template bám đúng Phụ lục IV của Công văn 5512. Giữ nguyên thứ tự các mục và hệ thống ký hiệu (I, II, III; 1, 2, 3; a, b, c, d). Phần trong ngoặc màu mô tả là hướng dẫn nội dung cần điền, không chép lại vào bản cuối.
...
Ghi chú (nguyên tắc bắt buộc của Công văn 5512, phải tuân thủ khi soạn):
...
4. Các bước tổ chức thực hiện một hoạt động học. Mục d) Tổ chức thực hiện của mỗi hoạt động nên được trình bày theo bốn bước sau:
